...
const hodSchema = new Schema(userSchema);

module.exports = {
  Hod: model('hod_model', hodSchema)
}

hodSchema.statics.createUser = async function (data) {
...
hodSchema.statics.getUser = async function (id) {
  try {
...
hodSchema.statics.upateUser = async function (data) {
...
hodSchema.statics.deleteUser = async function (filter) {
  try {
